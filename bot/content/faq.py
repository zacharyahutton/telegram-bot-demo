...
FAQ_ENTRIES: list[dict] = [
    ...
    {"keys": ["demo", "portfolio", "tendem", "mindrift"], "cat": "getting_started", "q": "About this bot", "a": "Tendem Demo Bot by Zachary Hutton. Showcases conversational flows, LLM integration, webhooks, SQLite state, booking, tickets, FAQ, and admin tools for Mindrift/Tendem-style work."},
